...
| [`2toINF/X-VLA-AgiWorld-Challenge`](https://huggingface.co/2toINF/X-VLA-AgiWorld-Challenge)        | AgiWorld          | Fine-tuned for embodied multimodal reasoning and manipulation tasks in AgiWorld Challenge.       | **Champion🥇**        | -  |
| [`2toINF/X-VLA-Calvin-ABC_D`](https://huggingface.co/2toINF/X-VLA-Calvin-ABC_D)                    | CALVIN ABC_D      | Fine-tuned on CALVIN benchmark (ABC_D subset) for vision-language robotic control.               | **4.41**        | [Calvin Eval](evaluation/calvin/README.md)          |
